 ...
 * 搜索群组的界面实现.
 */
public class SearchGroupFragment extends BasePresenterFragment<SearchContract.IPresenter>
        implements SearchActivity.SearchFragment,SearchContract.IGroupView{
